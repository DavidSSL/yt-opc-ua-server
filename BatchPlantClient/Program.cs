...
namespace BatchPlantClient
{
    class Program
    {
        ...
        {
            Console.WriteLine("Configure UA Client");
            ...
            var selectedEndpoint =
                CoreClientUtils.SelectEndpoint("opc.tcp://depacnglw1nb0sc:26543/BatchPlantServer", useSecurity: true);

            using (var session = Session
                .Create(config, new ConfiguredEndpoint(null, selectedEndpoint, EndpointConfiguration.Create(config)),
